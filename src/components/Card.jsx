      ...
      <div className="bg-[#181e24] h-80 w-64  items-center  ">
        ...
        <div className="bg-[#2a323c] p-2 pl-5 text-white   w-56 mx-4 rounded-md rounded-t-xl ">
          ...
          <div className="flex mt-5 ">
            <img src={logo} alt="bg" className="object-cover h-10 w-14  rounded-md" />
            <div>
              <h1 className="font-bold">Offer {data.offer} off</h1>
              <h1 className=" pl-2text-sm">on {data.brand}</h1>
            </div>
          </div>
        ...
        <div className="bg-[#2a323c] h-16 w-56 ml-4 rounded-md  rounded-b-xl py-2 px-12 ">
          <button className="text-center px-3 py-2 rounded-xl bg-slate-700 hover:scale-105 duration-300 ">Redeem Now</button>
        </div>
